    ...
    return (
        <div className="auth-container">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', margin: '16px 0' }}>
                ...
                <span style={{ color: 'var(--secondary-text)', fontSize: '12px' }}>OR</span>
                <hr style={{ flex: '1', borderColor: 'var(--border)' }} />
            </div>
            <form onSubmit={handleEmailPasswordSubmit}>
                ...
                {isLoginView && (
                    <p style={{ textAlign: 'right', marginTop: '-10px', marginBottom: '20px', fontSize: '14px' }}>
                        <a href="#forgot-password" style={{ color: 'var(--accent)', textDecoration: 'none', fontWeight: '600' }}>Forgot Password?</a>
                    </p>
                )}
            ...
            <p style={{ marginTop: '24px', fontSize: '14px', color: 'var(--secondary-text)' }}>
                {isLoginView ? "Don't have an account? " : "Already have an account? "}
                <span onClick={() => { setIsLoginView(!isLoginView); setError(''); }} style={{ color: 'var(--accent)', fontWeight: '600', cursor: 'pointer' }}>
